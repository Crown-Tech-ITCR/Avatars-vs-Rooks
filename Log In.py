...
def boton_ventana_registro_usuarios():
    root.destroy()
    ventana_registro_usuarios()

def ventana_registro_usuarios():
    root = tk.Tk()
    root.title("Registro de usario")
    root.geometry("500x300")
    root.configure(bg="black")

    tk.Label(root, text="Reconocimiento Facial (OpenCV + LBPH)", font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)

    tk.Button(root, text="Registrar nuevo rostro", command=register_face_gui, width=30, height=2, font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)
    tk.Button(root, text="Iniciar sesión con rostro", command=login_with_face_gui, width=30, height=2, font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)
    tk.Button(root, text="Salir", command=root.destroy, width=30, height=2, font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)
...
def main_gui():
    ...
    tk.Button(root, text="Registrar nuevo usuario", command=boton_ventana_registro_usuarios, width=30, height=2, font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)
    tk.Button(root, text="Iniciar sesión", command=login_with_face_gui, width=30, height=2, font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)
    tk.Button(root, text="Salir", command=root.destroy, width=30, height=2, font=("FixedSys", 14), bg='black', fg="#D9B41E").pack(pady=10)
