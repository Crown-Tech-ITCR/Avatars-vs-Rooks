...
class Avatar(Entidad):
    ...
    def tick(self):
        """Regenera vida si tiene regeneración activa."""
...
class AvatarFlechador(Avatar):
    """Avatar Flechador: Rápido, poco daño pero se regenera."""
    def __init__(self):
...
class AvatarEscudero(Avatar):
    """Avatar Escudero: Equilibrado con regeneración moderada."""
    def __init__(self):
...
class AvatarCanibal(Avatar):
    """Avatar Caníbal: Alto daño y regeneración alta."""
    def __init__(self):
...
class AvatarLenador(Avatar):
    """Avatar Leñador: Alto daño sin regeneración."""
    def __init__(self):
...
# DICCIONARIOS DE AYUDA PARA CREACIÓN DE ENTIDADES
